INSERT INTO systems(name, description, service_start, service_end, status_id, audit_frequency_id, last_audit, next_audit, approver_id, video_sop_link, written_sop_link, flowchart_link, audit_status_id) VALUES
    ...
    --ChatGPT generated
    ('Customer Support', 'Handles customer inquiries and complaints', '2023-02-01', NULL, 3, 7, '2023-05-01', '2026-09-01', 20, '', '', '', 3),
    ('Employee Performance Review', 'Conduct quarterly performance reviews for all employees', '2023-01-15', NULL, 2, 8, '2023-06-15', '2023-12-15', 9, '', '', '', 2);
    ("Expense Approval System", "Submit and approve employee expense claims", '2023-03-01', NULL, 3, 7, '2023-08-15', '2023-09-01', 11, "", "", "", 3);   
    ('Project Management Software', 'Organizes and tracks tasks and projects for teams', '0000-00-00', NULL, 1, 8, NULL, '0000-00-00', 4, "", "", "", 1); 
